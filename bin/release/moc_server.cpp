...
QT_MOC_LITERAL(5, 53, 15)
    ...
    "Server\0commandReceived\0\0newConnected\0"
    "newDisconnected\0newDataReceived"
};
...
void Server::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->commandReceived((*reinterpret_cast< QVariantMap(*)>(_a[1]))); break;
        case 1: _t->newConnected(); break;
        case 2: _t->newDisconnected(); break;
        case 3: _t->newDataReceived(); break;
        default: ;
        }
        ...
        {
            typedef void (Server::*_t)(QVariantMap );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Server::commandReceived)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Server::commandReceived(QVariantMap _t1)
{
